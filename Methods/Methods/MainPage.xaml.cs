...
namespace Methods
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void calculateClick(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                int leftHandSide = Int32.Parse(lhsOperand.Text);
                int rightHandSide = Int32.Parse(rhsOperand.Text);
                ...
                //Commenting out these lines of code to omit the dividende/remainder and, instead, return them as one
                /*
                //else if (division.IsChecked.HasValue && division.IsChecked.Value)
                {
